<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Forecast.aspx.cs" Inherits="RedHill.SalesInsight.Web.Reports.Forecast" %>
            ...
            <tr>
                <td>
                    <rsweb:ReportViewer ID="reportView" runat="server" Width="100%" Font-Names="Verdana"
                        ...
                        <LocalReport ReportPath="Reports\(Definitions)\Forecast.rdlc" />
                    </rsweb:ReportViewer>
                </td>
            </tr>
        </table>
